...
/*   Updated: 2023/02/07 16:00:37 by ayassir          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ShrubberyCreationForm::execute(Bureaucrat const &executor) const
{
	...
	outfile << tree;
	outfile.close();
	std::cout << "\""<< this->getName() << "_shrubbery\" file has been created" << std::endl;
}

AForm*	ShrubberyCreationForm::newForm(std::string name) const
{
